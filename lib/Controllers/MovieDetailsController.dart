...
class MovieDetailsController extends GetxController{
  ...
  void getMovieDetails(movieId) async{
    final getMovieResponse = await API.instance.get(endPoint: 'https://api.themoviedb.org/3/movie/$movieId?api_key=ae5827914ac9502d6a8148f89645728a&language=en-US');
