...
class HomeController extends GetxController {
  ...
  String searchUrl =
      'https://api.themoviedb.org/3/search/movie?api_key=${apiKey}&language=en-US&page=1&include_adult=false&query=spiderman';
  ...
  void searchMovies() async {
    final searchMoviesResponse = await API.instance.get(
        showLoader: false,
        endPoint:
            '${baseUrl}/search/movie?api_key=${apiKey}&language=en-US&page=1&include_adult=false&query=${searchTerm.text}');
